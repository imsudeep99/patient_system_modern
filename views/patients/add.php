...
// Show error (Aadhaar duplicate etc.)
$errorHtml = '';
if (!empty($_SESSION['error'])) {
    $errorHtml = '<div class="alert alert-danger">'.$_SESSION['error'].'</div>';
    ...
    <div class="card-body">
        ...
        <form method="post" enctype="multipart/form-data" action="/patient_system_modern/controllers/save_patient.php">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label class="form-label">Imaging / X-ray</label>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="aadhaar" class="form-control"
                        ...
                        placeholder="Unique Aadhaar number">
                </div>

                <div class="col-md-3">
                    <label class="form-label">Fees</label>
                    <input type="number" name="fees" min="0" max="9999"
       oninput="this.value=this.value.slice(0,4)" class="form-control">
                </div>

                <div class="col-md-3">
                    <label class="form-label">Discount</label>
                    <input type="number" name="discount" min="0" max="9999"
       oninput="this.value=this.value.slice(0,4)" class="form-control">
                </div>
